    ...
    def __init__(self) -> None:
        ...
        self._data = {
            "en": {
                ...
                "editor.follow.off": "Off",
                "editor.follow.page": "Page",
                "editor.follow.center": "Center",
                "editor.follow.smart": "Smart",
                "editor.wwm_mode": "🎮 WWM 36-Key",
                ...
                "scheme.beginner_36.name": "Beginner 36-Key",
                "scheme.beginner_36.desc": "4-row plain keys: ZXCVBNM / ASDFGHJKL / QWERTYUIOP / 1234567890, no modifiers",
                "scheme.generic_88.name": "Generic 88-Key",
                "scheme.generic_88.desc": "8×11 layout: layered Shift/Ctrl combos, full piano range",
                "scheme.heartbeat_37.name": "Heartbeat Town 37-Key",
                "scheme.heartbeat_37.desc": "3×12 layout: ,./(low) / ZXC(mid) / QWE(high), individual keys no modifiers",
                # Sort labels
                ...
                # Transpose suffix
                "live.transpose.suffix": " st",
                "live.out_of_range": "(out of range)",
                "editor.arrange.folded": "{count} note(s) folded into range",
                # Player bar
                ...
                "player.pause": "Pause",
                "player.stop": "Stop (F6 — works globally)",
                "hint.f6_panic": "💡 Press F6 anytime to stop playback (works even in-game)",
                ...
                "practice.empty.title": "Select a Track",
                "practice.empty.sub": "Open a MIDI file or pick one from your library.",
                "practice.open_file": "Open MIDI File...",
                "practice.library_tracks": "Library Tracks",
                "practice.no_tracks": "Library is empty — import MIDI files in the Library tab first.",
                "practice.change_track": "Change Track",
                ...
                "practice.total_notes": "Total Notes",
            ...
            "zh_tw": {
                ...
                "editor.zoom": "縮放",
                "editor.follow": "跟隨",
                "editor.follow.off": "關閉",
                "editor.follow.page": "翻頁",
                "editor.follow.center": "居中",
                "editor.follow.smart": "智能",
                "editor.wwm_mode": "🎮 燕雲 36 鍵",
                ...
                "scheme.beginner_36.name": "新手 36鍵",
                "scheme.beginner_36.desc": "4行純鍵盤：ZXCVBNM / ASDFGHJKL / QWERTYUIOP / 1234567890，無修飾鍵",
                "scheme.generic_88.name": "通用 88鍵",
                "scheme.generic_88.desc": "8×11 佈局：多層 Shift/Ctrl 組合，完整鋼琴範圍",
                "scheme.heartbeat_37.name": "心動小鎮 37鍵",
                "scheme.heartbeat_37.desc": "3×12 佈局：,./(低) / ZXC(中) / QWE(高)，獨立按鍵無修飾",
                "lib.sort.default": "預設順序",
                "lib.sort.name": "名稱",
                "lib.sort.bpm": "BPM",
                "lib.sort.notes": "音符數",
                "lib.sort.duration": "時長",
                "live.transpose.suffix": " 半音",
                "live.out_of_range": "(超出範圍)",
                "editor.arrange.folded": "{count} 個音符已折疊至可用範圍",
                ...
                "player.pause": "暫停",
                "player.stop": "停止 (F6 — 全域有效)",
                "hint.f6_panic": "💡 隨時按 F6 停止播放（遊戲中也有效）",
                ...
                "nav.practice": "練習",
                "practice.title": "練習模式",
                "practice.desc": "音符會從上方落下，在金線處準確按鍵即可得分。",
                "practice.empty.title": "選擇練習曲目",
                "practice.empty.sub": "開啟 MIDI 檔案，或從曲庫選擇一首曲目。",
                "practice.open_file": "開啟 MIDI 檔案...",
                "practice.library_tracks": "曲庫曲目",
                "practice.no_tracks": "曲庫為空，請先到曲庫匯入 MIDI 檔案。",
                "practice.change_track": "換曲",
                "practice.score": "分數",
            ...
            "zh_cn": {
                ...
                "editor.zoom": "缩放",
                "editor.follow": "跟随",
                "editor.follow.off": "关闭",
                "editor.follow.page": "翻页",
                "editor.follow.center": "居中",
                "editor.follow.smart": "智能",
                "editor.wwm_mode": "🎮 燕云 36 键",
                ...
                "scheme.beginner_36.name": "新手 36键",
                "scheme.beginner_36.desc": "4行纯键盘：ZXCVBNM / ASDFGHJKL / QWERTYUIOP / 1234567890，无修饰键",
                "scheme.generic_88.name": "通用 88键",
                "scheme.generic_88.desc": "8×11 布局：多层 Shift/Ctrl 组合，完整钢琴范围",
                "scheme.heartbeat_37.name": "心动小镇 37键",
                "scheme.heartbeat_37.desc": "3×12 布局：,./(低) / ZXC(中) / QWE(高)，独立按键无修饰",
                ...
                "live.transpose.suffix": " 半音",
                "live.out_of_range": "(超出范围)",
                "editor.arrange.folded": "{count} 个音符已折叠至可用范围",
                ...
                "player.pause": "暂停",
                "player.stop": "停止 (F6 — 全局有效)",
                "hint.f6_panic": "💡 随时按 F6 停止播放（游戏中也有效）",
                "player.prev": "上一首 (Ctrl+←)",
                "player.next": "下一首 (Ctrl+→)",
                ...
                "nav.practice": "练习",
                "practice.title": "练习模式",
                "practice.desc": "音符会从上方落下，在金线处准确按键即可得分。",
                "practice.empty.title": "选择练习曲目",
                "practice.empty.sub": "打开 MIDI 文件，或从曲库选择一首曲目。",
                "practice.open_file": "打开 MIDI 文件...",
                "practice.library_tracks": "曲库曲目",
                "practice.no_tracks": "曲库为空，请先到曲库导入 MIDI 文件。",
                "practice.change_track": "换曲",
                "practice.score": "分数",
            ...
            "ja": {
                ...
                "editor.zoom": "ズーム",
                "editor.follow": "フォロー",
                "editor.follow.off": "オフ",
                "editor.follow.page": "ページ",
                "editor.follow.center": "センター",
                "editor.follow.smart": "スマート",
                "editor.wwm_mode": "🎮 燕雲 36鍵",
                "editor.note_count": "{notes} 音符 · {bars} 小節",
                ...
                "scheme.beginner_36.name": "初心者 36鍵",
                "scheme.beginner_36.desc": "4行キーボード：ZXCVBNM / ASDFGHJKL / QWERTYUIOP / 1234567890、修飾キーなし",
                "scheme.generic_88.name": "汎用 88鍵",
                "scheme.generic_88.desc": "8×11 配列：Shift/Ctrl 多層組合、フルピアノ範囲",
                "scheme.heartbeat_37.name": "心動小鎮 37鍵",
                "scheme.heartbeat_37.desc": "3×12 配列：,./(低) / ZXC(中) / QWE(高)、個別キー修飾なし",
                ...
                "live.transpose.suffix": " 半音",
                "live.out_of_range": "(範囲外)",
                "editor.arrange.folded": "{count} 個のノートを範囲内に折り込みました",
                ...
                "player.pause": "一時停止",
                "player.stop": "停止 (F6 — グローバル)",
                "hint.f6_panic": "💡 いつでも F6 キーで再生を停止できます（ゲーム中でも有効）",
                ...
                "practice.desc": "上から音符が降ってくるので、金線のタイミングで正確にキーを押してスコアを獲得しましょう。",
                "practice.empty.title": "練習曲を選択",
                "practice.empty.sub": "MIDIファイルを開くか、ライブラリから選択してください。",
                "practice.open_file": "MIDIファイルを開く...",
                "practice.library_tracks": "ライブラリ曲目",
                "practice.no_tracks": "ライブラリが空です。先にライブラリタブでMIDIファイルをインポートしてください。",
                "practice.change_track": "曲を変更",
                "practice.score": "スコア",
                "practice.accuracy": "正確率",
                "practice.combo": "コンボ",
                "practice.perfect": "パーフェクト",
                "practice.great": "グレート",
                "practice.good": "グッド",
                "practice.miss": "ミス",
                "practice.start": "練習開始",
                "practice.stop": "停止",
                "practice.result": "成績",
                "practice.max_combo": "最大コンボ",
                "practice.retry": "リトライ",
                "practice.total_notes": "総ノート数",
            ...
            "ko": {
                ...
                "editor.follow": "팔로우",
                "editor.follow.off": "끔",
                "editor.follow.page": "페이지",
                "editor.follow.center": "중앙",
                "editor.follow.smart": "스마트",
                "editor.wwm_mode": "🎮 연운 36키",
                ...
                "scheme.beginner_36.name": "초보자 36키",
                "scheme.beginner_36.desc": "4행 순수 키보드: ZXCVBNM / ASDFGHJKL / QWERTYUIOP / 1234567890, 수정키 없음",
                "scheme.generic_88.name": "범용 88키",
                "scheme.generic_88.desc": "8×11 배열: Shift/Ctrl 다층 조합, 풀 피아노 범위",
                "scheme.heartbeat_37.name": "심동소진 37키",
                "scheme.heartbeat_37.desc": "3×12 배열: ,./(저) / ZXC(중) / QWE(고), 개별 키 수정키 없음",
                "lib.sort.default": "기본 순서",
                "lib.sort.name": "이름",
                "lib.sort.bpm": "BPM",
                "lib.sort.notes": "음표 수",
                "lib.sort.duration": "시간",
                "live.transpose.suffix": " 반음",
                "live.out_of_range": "(범위 밖)",
                "editor.arrange.folded": "{count}개 노트를 범위 내로 접었습니다",
                ...
                "player.pause": "일시정지",
                "player.stop": "정지 (F6 — 글로벌)",
                "hint.f6_panic": "💡 언제든지 F6을 눌러 재생을 중지할 수 있습니다 (게임 중에도 작동)",
                ...
                "practice.desc": "위에서 음표가 내려오면 금색 선에서 정확히 키를 눌러 점수를 획득하세요.",
                "practice.empty.title": "연습곡 선택",
                "practice.empty.sub": "MIDI 파일을 열거나 라이브러리에서 선택하세요.",
                "practice.open_file": "MIDI 파일 열기...",
                "practice.library_tracks": "라이브러리 곡목",
                "practice.no_tracks": "라이브러리가 비어 있습니다. 먼저 라이브러리 탭에서 MIDI 파일을 가져오세요.",
                "practice.change_track": "곡 변경",
                "practice.score": "점수",
                "practice.accuracy": "정확도",
                "practice.combo": "콤보",
                "practice.perfect": "퍼펙트",
                "practice.great": "그레이트",
                "practice.good": "굿",
                "practice.miss": "미스",
                ...
                "practice.stop": "정지",
                "practice.result": "결과",
                "practice.max_combo": "최대 콤보",
                "practice.retry": "재시도",
                "practice.total_notes": "총 음표",
